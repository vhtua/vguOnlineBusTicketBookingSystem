...
--
-- Host: db:3306
-- Generation Time: May 21, 2023 at 07:41 AM
...
('17965', 'Anh', 'Ba Nguyen Quoc', '17965@student.vgu.edu.vn', '$2y$10$vWDCncOZYLWV6f/QSL92s.d7zEbiemfsiFzst46MEIx4MveE8Poay', 'CSE 2020', '012345678912'),
...
(1, 'Turtle Lake → VGU Campus', '2023-05-22', 100000),
(2, 'VGU Campus → Turtle Lake', '2023-05-22', 100000),
(3, 'Turtle Lake → VGU Campus', '2023-05-23', 100000),
(4, 'VGU Campus → Turtle Lake', '2023-05-23', 100000),
(5, 'Turtle Lake → VGU Campus', '2023-05-24', 100000),
(6, 'VGU Campus → Turtle Lake', '2023-05-24', 100000);
...
--
ALTER TABLE `notification`
  MODIFY `notification_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
